...
import org.bengo.entity.user.*;
import org.bengo.mapper.user.PermissionMapper;
import org.bengo.service.user.PermissionService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import org.bengo.service.user.RolePermissionService;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission> implements PermissionService {
    ...
    public Map<String, Object> initMenu(Long uId) {
        ...
        menuKey2.setTitle("短视频个性化推荐");
        menuKey2.setHref("/index.html");
        data.put("state", true); // 添加成功状态
